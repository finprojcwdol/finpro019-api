...
class UserProfileRouter {
    ...
    initializeRoutes() {
        this.router.post("/get2", auth_1.authenticateToken, this.PropertyController.getDetails);
        this.router.post("/get1", auth_1.authenticateToken, this.userProfileController.getProfile);
        this.router.post("/get3", auth_1.authenticateToken, this.userProfileController.getProfile);
